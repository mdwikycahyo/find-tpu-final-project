...
//           .collection(collectionKeeper)
//           .findOne({ keeperEmail: email });
//       }
//     } catch (err) {
//       console.log(err);
//     }
...
//         const cemetarySpace = await getDatabase()
//           .collection(collectionCemetarySpace)
//           .insertOne(cemetary);
//         keeperData.cemetarySpaceId = cemetarySpace.ops[0]._id;
//         return await getDatabase()
//           .collection(collectionKeeper)
//           .insertOne(keeperData);
//       } else {
//         console.log(err);
//       }
//     } catch (err) {
...
//     try {
//       if (getDatabase()) {
//         let keeperData = await getDatabase()
//           .collection(collectionKeeper)
//           .find({ _id: ObjectId(id) })
//           .toArray();
//         let cemetarySpaceId = keeperData[0].cemetarySpaceId;
//         let cemetaryData = await getDatabase()
//           .collection(collectionCemetarySpace)
//           .find({ _id: ObjectId(cemetarySpaceId) })
//           .toArray();
...
//         .find({ _id: ObjectId(id) })
//         .toArray();
//       let cemetarySpaceData = await getDatabase()
//         .collection(collectionCemetarySpace)
//         .find({ _id: ObjectId(cemetarySpaceId) })
//         .toArray();
...
//       await getDatabase()
//         .collection(collectionKeeper)
//         .updateOne({ _id: ObjectId(id) }, newCemetaryData);
//       await getDatabase()
//         .collection(collectionCemetarySpace)
//         .updateOne({ _id: ObjectId(cemetarySpaceId) }, newCemetarySpaceData);
//       return "";
//     }
//   } catch (err) {
//     console.log(err);
